...
Status: **v1.0 — FROZEN 2026-08-17** (changes only via ADR + doc edit in the same PR; `spec-drift-reviewer` enforces) — amended by ADR-0006 (2026-08-17) — amended by ADR-0009, ADR-0010, ADR-0011, ADR-0012 (2026-08-20) — amended by ADR-0014 (2026-08-20) — amended by ADR-0015, ADR-0016 (2026-08-20)
...
| 2026-08-20 | v1.0 | ADR-0009 | ADR-0009 — middleware file is `proxy.ts` (Next 16 convention): the S1.1 middleware lives in `proxy.ts` at the repo root with the named export `proxy` + `config.matcher`; 02 §3 M1–M8, RP-19/RP-20 and 01 INV-30/32 apply unchanged; every `middleware.ts` in this doc (S1.1 Scope IN, gate focus) reads as `proxy.ts`. |
