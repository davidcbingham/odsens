...
| 2026-09-18 | v1.0 | ADR-0041 | S1.5b Session A findings: the Ko-fi `frame-src` entry stays site-wide (01 §20 unchanged) and "only on `/support`" is the INV-58 code rule — §S1.5b Scope IN reworded; Tests required gains T-UNIT-54 |
