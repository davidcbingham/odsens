...
| ADR-0009 | Middleware file is `proxy.ts` (Next 16 convention) | Proposed | 2026-08-20 | S1.1 | 02 §3 heading, RP-19, RP-20 + Status line; 01 §1 tree, INV-14, INV-30, INV-32, INV-42 + Status line; 01 INV-13, INV-85 (addendum 2026-08-20); 04 SC-04 + Status line; `_registry.md` Route files + tree; 00 S1.1 Scope IN, §6 + Status line; `docs/questions.md` S0 notes |
