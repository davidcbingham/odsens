...
| ADR-0029 | Builds wait for the database schema (`scripts/wait-for-schema.mjs`, RPC `migration_versions()`) | Proposed | 2026-09-03 | S1.5 | 05 §4 CI-4, T-RLS-129, T-UNIT-46, §8 S1.5 + Status line; `_registry.md` scripts + SQL lines; 00 §6 + Status line; `ship` step 10; `vercel-ops` troubleshooting; `docs/dev-tooling.md`; `docs/questions.md` S1.5 notes |
| ADR-0030 | S1.5 contract clarifications (notify orchestration, shared runner, `sync.stale` subject, payload retention, settings composition, adapters over `fetchJson`, `Digest`, fixture-server POST); D14–D20 build-pass and gate-round letter (settings-action/email/schema letter, moderator 404 interim, COV-4 combined run, settings page as built, D20 gate round 1: 01 §1 tree + INV-78, 02 §1.3 entry button, 05 T-E2E-35, `DELIVER_TIME_BUDGET_MS` 12000) | Proposed | 2026-09-03 | S1.5 | 04 SC-09, SC-22, §1.1 `deleteAccount`, §1.3 `setUserRole`, §2.4, §3 preamble, J-F, J-S, §3.7 N2/N4/N5/N6, §4.5, §4.6, §5.8 + Status line; 01 INV-71; 03 C-03, §2.2 `Toggle`/`Chip`, §2.10 `NotificationMatrix`, §2.11 rows, E-01/E-03/E-05/E-06/E-07 + Status line; 02 §2.8 + Status line; 05 F-3, SEED-12, H-4, COV-4, T-RLS-129, T-ACT-30/32/52/65/66/72/74, T-ADP-18/19, T-UNIT-3/26, T-E2E-37 + Status line; `docs/data-model.md` §2.6, §2.11; `docs/notifications.md`; `_registry.md` Jobs, Modules, Adapters, Notify, Email lines; 00 §6 + Status line; `docs/questions.md` S1.5 notes |
| ADR-0031 | Sign-out's CSRF check compares `Origin` against the request's own host (production logout returned 403) | Proposed | 2026-09-06 | cross-cutting | 04 §2.2 + §7 env matrix + Status line; 02 §4 Sign-out + §1.2 route table row + Status line; 05 §7.2 T-ACT-9 + Status line; `docs/questions.md` 2026-09-06 |
| ADR-0032 | The crown alone is the site mark; the full OddSense character is Oliver's account picture | Proposed | 2026-09-06 | cross-cutting | `DESIGN.md` header changelog (v1.6), §2 Palette, §10 Assets |
| ADR-0033 | The admin header carries the odsens mark as the way back to the public site | Proposed | 2026-09-06 | cross-cutting | 03 §2.10 `AdminShell` row + Status line; `DESIGN.md` §9 (9) + changelog (v1.7); 05 §7.3 T-E2E-33 + Status line; `docs/questions.md` 2026-09-06 |
