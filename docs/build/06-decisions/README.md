...
| ADR-0014 | Profile page island and own-row columns | Proposed | 2026-08-20 | S1.1 | `_registry.md` Accounts; 03 C-03, C-08, C-16a, §2.2, §2.5, §2.10, §3, §7, §12 + Status line; 01 INV-45 + Status line; 04 SC-04 + Status line; 05 §1.1 + Status line; 00 §6 + Status line; `docs/questions.md` S1.1 notes; `docs/spec.md` revision log |
