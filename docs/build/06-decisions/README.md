...
| ADR-0036 | Build order after Oliver's first use: S1.5a Cross-posted projects + S1.5b Support page inserted before S1.6; S1.9 narrowed to Stats | Proposed | 2026-09-11 | cross-cutting | 00 §1.4, §1.7, §2 (S1.5a, S1.5b, S1.9), §4.1–4.3, §6 + Status; 01 §7 + Status; 02 §1.1/§2/§6/§8 + Status; 03 §2 slice cells + Status; 04 §5.7 + Status; 05 §8 + Status; `_registry.md` ID conventions + Slices; `START-BUILD.md`; `docs/questions.md` |
