...
| ADR-0026 | Version identity: `external_id` for synced versions, `(project_id, version_number)` for exclusives only | Proposed | 2026-08-27 | S1.3 | `docs/data-model.md` §2.2 `project_versions`; 05 §12 note (T-ACT-48 duplicate case); `docs/questions.md` S1.3 notes |
