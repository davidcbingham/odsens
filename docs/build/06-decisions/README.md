...
| ADR-0035 | Look-and-feel fixes from Oliver's first use: themed `Select` listbox (client island), 2 px avatar outline, route-change fade, `CheckGrid` loaders, tip line | Proposed | 2026-09-11 | cross-cutting | 03 §2.2 `Select`/`Avatar`/`CheckGrid` + §1.4 island list + §2.3 `TipPanel` + Status; 01 §1 tree; `DESIGN.md` §3/§5/§8 + changelog v1.8; 05 T-E2E-2, T-E2E-35, T-E2E-50, §8 + Status; `_registry.md`; 00 §6 |
