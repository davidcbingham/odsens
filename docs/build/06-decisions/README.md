...
| ADR-0015 | Profiles mutations on other rows via the service client | Proposed | 2026-08-20 | S1.1 | 05 §7.1 T-RLS-5, T-RLS-8, T-RLS-9 + Status line; `docs/data-model.md` §4 `profiles`; 00 §6 + Status line; `docs/questions.md` S1.1 notes; `docs/spec.md` revision log |
