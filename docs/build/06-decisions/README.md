...
| ADR-0036 | Build order after Oliver's first use: S1.5a Cross-posted projects + S1.5b Support page inserted before S1.6; S1.9 narrowed to Stats | Proposed | 2026-09-11 | cross-cutting | 00 §1.4, §1.7, §2 (S1.5a, S1.5b, S1.9), §4.2, §4.3, §6; `_registry.md` ID conventions + Slices; 02 §8; 05 §8; `START-BUILD.md` |
