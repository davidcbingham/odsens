...
| ADR-0003 | CSP script-src 'unsafe-inline' for v1 | Proposed | 2026-08-17 | S0 | 01 §20 INV-77 `script-src` row; 01 Status line |
| ADR-0004 | Dev-only component preview route | Proposed | 2026-08-17 | S0 | 03 §7, §12, Status line; `_registry.md` Non-production line |
