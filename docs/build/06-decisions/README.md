...
| ADR-0034 | Catalogue fixes from Oliver's first use: synced slugs normalised, loader display names, versions-table ranges, full-size Modrinth images | Proposed | 2026-09-11 | cross-cutting | 04 §3.1 Steps + §4.1 exports + Status line; 03 §2.3 `VersionsTable`/`GetItPanel` rows + Status line; 05 T-ACT-78, T-ADP-4, T-ADP-21, T-UNIT-47, T-UNIT-48, §8 S1.2 + Status line; `docs/data-model.md` §2 `icon_url`/`gallery`; `_registry.md` Modules/Adapters; 00 §6 |
