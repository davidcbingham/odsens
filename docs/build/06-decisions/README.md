...
| ADR-0030 | S1.5 contract clarifications (notify orchestration, shared runner, `sync.stale` subject, payload retention, settings composition, adapters over `fetchJson`, `Digest`, fixture-server POST) | Proposed | 2026-09-03 | S1.5 | 04 SC-09, SC-22, §1.1 `deleteAccount`, §1.3 `setUserRole`, §2.4, §3 preamble, J-F, J-S, §3.7 N2/N4/N5/N6, §4.5, §4.6, §5.8 + Status line; 01 INV-71; 03 C-03, §2.2 `Toggle`/`Chip`, §2.10 `NotificationMatrix`, §2.11 rows, E-01/E-03/E-05/E-06/E-07 + Status line; 02 §2.8 + Status line; 05 F-3, SEED-12, H-4, COV-4, T-RLS-129, T-ACT-30/32/52/65/66/72/74, T-ADP-18/19, T-UNIT-3/26, T-E2E-37 + Status line; `docs/data-model.md` §2.6, §2.11; `docs/notifications.md`; `_registry.md` Jobs, Modules, Adapters, Notify, Email lines; 00 §6 + Status line; `docs/questions.md` S1.5 notes |
