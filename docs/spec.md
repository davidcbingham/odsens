...
*Revision log*
- 2026-09-25 — **S1.8 follow-ups fix pass built** on `fix/S1.8-followups` (ADR-0046 Proposed, D1–D6): the admin preview card and the by-hand fields show the link that will be stored; error pages are no longer read in full; the filter buttons keep the gold focus ring; four boundary tests. No schema, no tag.
